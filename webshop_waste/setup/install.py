...
from webshop_waste.webshop_waste.utils.setup import has_ecommerce_fields
...
def say_thanks():
	click.secho("Thank you for installing Frappe webshop_waste!", color="green")
...
def run_patches():
	...
	try:
		for patch in patches:
			frappe.get_attr(f"webshop_waste.patches.{patch}.execute")()
