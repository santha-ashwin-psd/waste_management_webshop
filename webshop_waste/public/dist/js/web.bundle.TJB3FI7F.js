(() => {
  ...
  webshop_waste.ProductGrid = class {
    ...
    make() {
      ...
      this.items.forEach((item) => {
        ...
        html += `<div class="col-sm-4 item-card col-12 col-lg-3 "><div class="card text-left shadow-sm">`;
        ...
        return `
				<div class="card-img-container">
					<a href="/${item.route || "#"}" style="text-decoration: none;">
						<img itemprop="image" class="card-img m-0" src="${image}" style="width: 338px;object-fit: cover;border-radius:0 !important;" alt="${title}">
					</a>
				</div>
			`;
      } else {
    ...
    get_card_body_html(item, title, settings) {
      let body_html = `
			<div class="card-body text-left card-body-flex" style="background-color:#272b3b;width:100%">
      ...
      body_html += `</div>`;
      body_html += `<div class="product-category text-white" itemprop="name" style="font-size: 18px;font-weight: 500;">${item.item_group || ""}</div>`;
    ...
    get_title(item, title) {
      let title_html = `
			<a href="/${item.route || "#"}">
				<div class="product-title" itemprop="name" style="color:#fff;font-size: 24px;font-weight: 700;">
					${title || ""}
				</div>
			</a>
		`;
    ...
    get_price_html(item) {
      let price_html = `
			<div class="product-price" style="color:#30b954;" itemprop="offers" itemscope itemtype="https://schema.org/AggregateOffer">
      ...
      if (item.has_variants) {
        ...
        return `
				<div id="${item.name}" class="btn
					...
					data-item-code="${item.item_code}" style="border-radius:0 !important;background-color:#f2a102f2;">
					<span class="mr-2">
  ...
  webshop_waste.ProductList = class {
    ...
    make() {
      ...
      this.items.forEach((item) => {
        ...
        html += `<div class='row w-100 mb-4' style="border-radius:0 !important; background-color: #272b3b;">`;
    ...
    get_image_html(item, title, settings) {
      ...
      if (image) {
        image_html += `
				<div class="col-2 text-center rounded list-image p-0">
					<a class="product-link product-list-link" href="/${item.route || "#"}">
						<img itemprop="image" class="website-image h-100 w-100" style="object-fit: cover;" alt="${title}"
							src="${image}">
					</a>
    ...
    get_row_body_html(item, title, settings) {
      let body_html = `<div class='col-10 mt-2 text-left'>`;
    ...
    get_title_html(item, title, settings) {
      ...
      title_html += `
			<div class="col-8" style="margin-right: -15px;">
				<a class="text-white" href="/${item.route || "#"}"
    ...
    get_item_details(item, settings) {
      let details = `
			<p class="product-code text-white mt-2 mb-1" style="font-size: 14px;">
        ...
        return `
				<div id="${item.name}" class="btn
					...
					style="margin-top: 0px !important; max-height: 30px; float: right;
						padding: 0.25rem 1rem; min-width: 135px;border-radius: 0 !important;background-color: #f2a102f2;">
					<span class="mr-2">
						<svg class="icon icon-md">
							<use href="#icon-assets"></use>
						</svg>
				...
				<a href="/cart">
					<div id="${item.name}" class="btn
						...
						${item.in_cart ? "" : "hidden"}"
						data-item-code="${item.item_code}"
						style="padding: 0.25rem 1rem; min-width: 135px;border-radius: 0 !important;background-color: #f2a102f2;">
						${settings.enable_checkout ? __("Go to Cart") : __("Go to Quote")}
					</div>
				</a>
			`;
  ...
  webshop_waste.ProductView = class {
    ...
    add_paging_section(settings) {
      ...
      if (this.products) {
        let paging_html = `
				<div class="row product-paging-area container-fluid pb-4 mt-5">
					<div class="col-3">
					</div>
