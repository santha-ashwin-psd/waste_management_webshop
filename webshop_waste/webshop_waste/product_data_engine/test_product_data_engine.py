...
from webshop_waste.webshop_waste.doctype.website_item.test_website_item import create_regular_web_item
from webshop_waste.webshop_waste.product_data_engine.filters import ProductFiltersBuilder
from webshop_waste.webshop_waste.product_data_engine.query import ProductQuery
...
class TestProductDataEngine(unittest.TestCase):
	...
	def test_product_list_discount_filter_builder(self):
		...
		from webshop_waste.webshop_waste.doctype.website_item.test_website_item import (
			make_web_item_price,
	...
	def test_product_list_with_api(self):
		...
		from webshop_waste.webshop_waste.api import get_product_filter_data
	...
	def test_product_list_with_variants(self):
		...
		setup_webshop_waste_settings({"enable_attribute_filters": 0, "hide_variants": 1})
		frappe.local.shopping_cart_settings = None
		...
		# tear down
		setup_webshop_waste_settings({"enable_attribute_filters": 1, "hide_variants": 0})
