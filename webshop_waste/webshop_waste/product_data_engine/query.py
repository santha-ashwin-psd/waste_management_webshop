...
from webshop_waste.webshop_waste.doctype.item_review.item_review import get_customer
from webshop_waste.webshop_waste.shopping_cart.product_info import get_product_info_for_website
from webshop_waste.webshop_waste.utils.product import get_non_stock_item_status
...
class ProductQuery:
	...
	def build_item_group_filters(self, item_group):
		...
		from webshop_waste.webshop_waste.doctype.override_doctype.item_group import get_child_groups_for_website
	...
	def get_stock_availability(self, item):
		...
		from webshop_waste.templates.pages.wishlist import (
