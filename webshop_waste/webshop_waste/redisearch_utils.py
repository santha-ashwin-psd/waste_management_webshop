...
def is_redisearch_enabled():
	...
	is_redisearch_enabled = frappe.db.get_single_value("webshop_waste Settings", "is_redisearch_enabled")
...
def create_website_items_index():
	...
	# Index fields mentioned in webshop_waste settings
	idx_fields = frappe.db.get_single_value("webshop_waste Settings", "search_index_fields")
...
def get_fields_indexed():
	fields_to_index = frappe.db.get_single_value("webshop_waste Settings", "search_index_fields")
