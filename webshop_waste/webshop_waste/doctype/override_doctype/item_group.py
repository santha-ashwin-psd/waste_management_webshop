...
class webshop_wasteItemGroup(ItemGroup, WebsiteGenerator):
	...
	def validate(self):
		...
		super(webshop_wasteItemGroup, self).validate()

	def on_update(self):
		invalidate_cache_for(self)
		super(webshop_wasteItemGroup, self).on_update()
	...
	def on_trash(self):
		...
		super(webshop_wasteItemGroup, self).on_trash()
