...
from webshop_waste.webshop_waste.redisearch_utils import (
    delete_item_from_index,
    insert_item_to_index,
    update_index_for_item,
)
from webshop_waste.webshop_waste.shopping_cart.cart import _set_price_list
from webshop_waste.webshop_waste.doctype.override_doctype.item_group import (
    get_parent_item_groups,
    invalidate_cache_for,
)
from erpnext.stock.doctype.item.item import Item
from erpnext.utilities.product import get_price
from webshop_waste.webshop_waste.shopping_cart.cart import get_party
from webshop_waste.webshop_waste.variant_selector.item_variants_cache import (
...
class WebsiteItem(WebsiteGenerator):
	...
	def set_shopping_cart_data(self, context):
		from webshop_waste.webshop_waste.shopping_cart.product_info import (
