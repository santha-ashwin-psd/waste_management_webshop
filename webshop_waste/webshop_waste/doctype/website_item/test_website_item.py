...
from webshop_waste.webshop_waste.doctype.override_doctype.item import DataValidationError
from erpnext.stock.doctype.item.test_item import make_item
from webshop_waste.webshop_waste.doctype.override_doctype.item_group import get_parent_item_groups
...
class TestWebsiteItem(unittest.TestCase):
	...
	def test_index_creation(self):
		...
		from webshop_waste.webshop_waste.doctype.website_item.website_item import on_doctype_update
