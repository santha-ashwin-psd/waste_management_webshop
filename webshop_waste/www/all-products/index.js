$(() => {
	class ProductListing {
		...
		bind_card_actions() {
			webshop_waste.webshop_waste.shopping_cart.bind_add_to_cart_action();
			webshop_waste.webshop_waste.wishlist.bind_wishlist_action();
		}
	}
