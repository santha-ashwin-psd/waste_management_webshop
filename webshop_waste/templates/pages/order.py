...
from webshop_waste.webshop_waste.doctype.webshop_waste_settings.webshop_waste_settings import show_attachments
...
def get_context(context):
	...
	context.enabled_checkout = frappe.get_doc("webshop_waste Settings").enable_checkout
