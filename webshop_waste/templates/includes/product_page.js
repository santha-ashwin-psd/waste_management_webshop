...
frappe.ready(function() {
	...
	frappe.call({
		type: "POST",
		method: "webshop_waste.webshop_waste.shopping_cart.product_info.get_product_info_for_website",
		args: {
	...
	$("#item-add-to-cart button").on("click", function() {
		frappe.provide('webshop_waste.shopping_cart');

		webshop_waste.shopping_cart.update_cart({
			item_code: get_item_code(),
